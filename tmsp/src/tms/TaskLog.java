...
class TaskLog extends TaskManagementSystem {
    ...
    public void viewTaskLog() {
        File inputFile = new File("tasklogs.txt");
    ...
    private void saveToFile() {
        try (PrintWriter writer = new PrintWriter(new FileOutputStream("tasklogs.txt", true))) {
    ...
    private void updateInFile() {
        File inputFile = new File("tasklogs.txt");
        File tempFile = new File("temp_tasklogs.txt");
