...
public class EmployeeRequests extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Request Sumbition");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String type= jTextPane1.getText();
        
        
         if((EID.isEmpty()||RID.isEmpty()||type.isEmpty())){
             ...
             PermissionRequest x= new PermissionRequest(rid,eid,type);
             x.submitPermissionRequestG();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        String type= jTextPane1.getText();
         ...
         if((EID.isEmpty()||RID.isEmpty()||type.isEmpty())){
             ...
             LeaveRequest x= new LeaveRequest(eid,rid,type);
