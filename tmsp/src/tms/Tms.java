...
//        PermissionRequest x= new PermissionRequest(12,"Alice Johnson","Manager",40,"Fire Employee with ID: 240","2024-12-12","Pending");
       LeaveRequest y= new LeaveRequest();
//        x.submitPermissionRequest();
//        y.SumbitLR();
       y.updatea("21");
...
//        PermissionRequest permissionRequest = new PermissionRequest(101, "Jane Smith", "Designer", 2, "Work From Home", "2024-12-21", "Pending");
//        permissionRequest.submitPermissionRequest();
//        permissionRequest.approvePermissionRequest(101);    
    
    
//    String S="Employee ID =240 --- Name = Aaliceson John --- Role = Employee --- LRid = 21 --- LRtype = Vacation --- LRstartDate = 2024-12-1 --- LRendDate = 2124-12-1 --- LRstatus = Pending\n";
//    System.out.println(S.replaceAll("LRstatus = Pending", "LRstatus = Approved"));
